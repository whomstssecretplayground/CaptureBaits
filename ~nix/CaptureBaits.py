...
def get_stream(playlist, directory, own_name):
    ...
    if not os.path.isfile(stream_file):
        subprocess.check_call(["livestreamer", "--http-header", "User-Agent=Mozilla/5.0 (X11; Fedora; Linux x86_64; rv:50.0) Gecko/20100101 Firefox/50.0", "-o",  stream_file , hlsvar, "best"])
